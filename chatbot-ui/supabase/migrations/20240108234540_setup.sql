...
AS $$
DECLARE
  project_url TEXT := 'https://jilkbkqyatpysqyqpwou.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImppbGtia3F5YXRweXNxeXFwd291Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0OTczMTI4MywiZXhwIjoyMDY1MzA3MjgzfQ.9K0TeVB5QY93rxrc-KlrPSCeN2Xglyb2m_fLB8jlIhY'; -- full access needed for http request to storage
